      ...
      <form >
        <DialogContent className="sm:max-w-[425px]">
            ...
            <Controller
              ...
              render={({ field }) => (
                <div className="grid gap-2">
                  ...
                  <Input id="send-invite-phone" name="phone" placeholder="Enter phone" {...field} error={errors.phone?.message} />
                </div>
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <div className="grid gap-2">
                  ...
                  <Input type="textarea" rows={3} id="send-invite-notes" name="notes" placeholder="Enter notes" {...field} error={errors.notes?.message} />
                </div>
              )}
            />
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit(onSubmit)} disabled={loading}>{loading ? <span className="flex items-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Sending...</span> : 'Send Invite'}</Button>
          </DialogFooter>
        </DialogContent>
      </form>
    </Dialog>
