...
const VerificationFailed = () => {
    return (
        <div className='flex flex-col gap-4 items-center justify-center '>
            <div className='size-20'>
                <img src="/VerificationFailed.svg" alt="verification" className='w-full h-full object-cover' />
            </div>
            <p className='text-2xl font-bold tracking-tighter'>We could not verify your passport</p>
            <p>Reason: <span className='font-semibold'>The image was too blurry</span></p>
            <Button variant='secondary' className='w-[200px] font-bold'>Retry Verification</Button>
        </div>
    )
}
...
export const ProfileCard = () => {
    return (
        <div className='flex items-center gap-4 bg-brown flex-shrink-0 max-w-[400px] py-8 px-8 rounded-md'>
            ...
            <div>
                <h4 className='text-2xl font-bold tracking-tighter'>Sarah Miller</h4>
                <p>sarah.miller@example.com</p>
            </div>
        </div>
    )
}
            ...
            <div className='flex justify-between items-center'>
                ...
                <div className='flex gap-4'>
                    ...
                    <Link href='/customer/dashboard/application/new'>
                        <Button className={' bg-[#402E7A]'}><Plus /> Start New Application</Button>
                    </Link>
                </div>
