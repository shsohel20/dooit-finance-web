...
export default function ComplianceDashboard() {
  ...
  const resources = [
    ...
    },
    {
      ...
      description:
        "US federal laws requiring financial institutions to assist government agencies in detecting and preventing money laundering",
      category: "Regulatory",
    ...
    },
    {
      ...
      description:
        "The 5th EU Anti-Money Laundering Directive of the European Union, essential and immediate actions for customer due diligence",
      category: "Regulatory",
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8 blurry-overlay">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor regulatory requirements and manage compliance tasks
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {metrics.map((metric, idx) => (
            <Card
              key={idx}
              className="border border-border bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-colors"
            >
              <div className="p-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            {resources.map((resource, idx) => (
              <Card
                key={idx}
                className="border border-border bg-card/50 backdrop-blur-sm hover:bg-card/80 transition-colors overflow-hidden"
              >
                <div className="p-6">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    ...
                    <Badge className="bg-primary/20 text-primary border border-primary/30 whitespace-nowrap">
                      {resource.badge}
                    </Badge>
                  </div>
