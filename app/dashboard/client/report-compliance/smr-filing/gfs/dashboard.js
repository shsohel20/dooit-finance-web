  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="border-border/50 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">By Suspicion Type</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
                    ...
                    dataKey="value"
                  >
                    {suspicionTypeData.map((entry, index) => (
            ...
            <div className="mt-2 space-y-1">
              {suspicionTypeData.slice(0, 3).map((item, i) => (
        ...
        <Card className="border-border/50 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">By Country (Top 5)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
      ...
      {/* <div className="grid gap-4 md:grid-cols-2">
        <Card className="border-border/50 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Suspicion Amount Trend</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
      ...
      {/* <Card className="border-border/50 shadow-sm">
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium">Deposited vs Withdrawn Over Time</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={monthlyData}>
                ...
                />
                <Legend />
                <Line type="monotone" dataKey="deposited" stroke={COLORS[1]} strokeWidth={2} name="Deposited" />
                <Line type="monotone" dataKey="withdrawn" stroke={COLORS[3]} strokeWidth={2} name="Withdrawn" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </CardContent>
