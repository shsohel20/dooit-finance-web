    ...
    <div className="min-h-screen ">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
          ...
          <Card className="border-border/50">
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div>
                ...
                <p className="font-semibold text-foreground">
                  {directors_beneficial_owner.number_of_directors}
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="mb-8 flex flex-wrap gap-3">
          <Badge
            variant={customer?.isPep ? "destructive" : "outline"}
          ...
          <Badge
            variant={customer?.sanction ? "destructive" : "outline"}
            className="gap-1.5 px-3 py-1.5"
          >
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <SectionCard title="Personal Information" icon={User}>
            <div className="grid gap-4 sm:grid-cols-2">
              <DataField
                label="Full Name"
                value={`${personal?.customer_details?.given_name} ${personal?.customer_details?.middle_name} ${personal?.customer_details?.surname}`}
              />
              <DataField label="Other Names" value={personal?.customer_details?.other_names} />
              <DataField
                label="Date of Birth"
                value={formatDate(personal?.customer_details?.date_of_birth)}
              />
              <DataField label="Country" value={customer?.country} />
              <DataField label="Referral Source" value={personal?.customer_details?.referral} />
              <DataField
                label="Sole Trader"
                value={customer?.personalKyc?.sole_trader?.is_sole_trader}
              />
            </div>
          </SectionCard>
          ...
          <SectionCard title="Funds & Wealth" icon={DollarSign}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <DataField
                ...
                value={formatCurrency(funds?.estimated_trading_volume)}
              />
            </div>
          </SectionCard>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <SectionCard title="Company Details" icon={Building2}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <DataField
                ...
                value={general_information?.registration_number}
              />
              <DataField
              ...
              <DataField
                ...
                value={general_information?.nature_of_business}
              />
            </div>
          </SectionCard>
          ...
          <SectionCard title="Financial Information" icon={DollarSign}>
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <DataField
                label="Estimated Trading Volume"
                value={general_information?.estimated_trading_volume}
              />
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {general_information?.account_purpose?.fx && <Badge variant="secondary">FX</Badge>}
                {general_information?.account_purpose?.other && (
                  <Badge variant="secondary">
                    {general_information?.account_purpose?.other_details}
                  </Badge>
                )}
              </div>
            </div>
          ...
          <SectionCard title="Beneficial Owners" icon={User}>
            <div className="space-y-4">
              {directors_beneficial_owner?.beneficial_owners?.map((owner) => (
                <div key={owner._id} className="rounded-lg border border-border bg-muted/30 p-4">
