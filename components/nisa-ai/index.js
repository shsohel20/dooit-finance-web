  ...
  return (
    <>
      ...
      <div ref={chatRef} className={cn('fixed w-full max-w-[450px] bottom-2  h-[500px]   transition-transform duration-500 ease-in-out translate-x-full rounded-xl  bg-white shadow-xl border-t', {
        ...
        <Button size="icon" variant="outline" className='absolute top-2 right-3 size-7' onClick={() => setIsOpen(false)}><X size={12} /></Button>
        {/* chat */}
            ...
            <div className='h-full w-full  rounded-lg '>
              ...
              <div className='flex justify-between items-center p-2'>
                <div className='flex gap-2'>
                  ...
                  <Button size="icon" variant="outline"><AudioLines /></Button>
                </div>
                <div>
