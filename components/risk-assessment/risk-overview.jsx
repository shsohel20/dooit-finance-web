    ...
    <div className="space-y-6">
      <Card className="border-primary">
        <CardHeader>
          ...
          <CardDescription>
            Built on globally and locally recognized standards for robust ML/TF
            risk management
          </CardDescription>
        </CardHeader>
          ...
          <div className="space-y-3 text-sm">
            <div className="space-y-1">
              <div className="font-semibold text-base">
                Overall Methodology & Jurisdiction Risk
              </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Categorised using the latest <strong>ANZSCO</strong> (Australian
                and New Zealand Standard Classification of Occupations)
                classifications, enhanced by internal risk factors related to
                exposure to cash, crypto-assets, and other ML/TF predicate
                activities.
              </p>
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Customers are assigned a risk rating based on a composite score
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Inherent risk distribution by likelihood and impact
            </CardDescription>
          </CardHeader>
          <CardContent>
            <RiskMatrix />
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Breakdown of risks across different categories
            </CardDescription>
          </CardHeader>
          <CardContent>
