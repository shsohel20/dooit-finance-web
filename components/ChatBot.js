...
export default function ChatBot() {
  ...
  return (
    <div
      ref={chatBotRef}
      className={cn(
        "chat-bot fixed bottom-4 right-4 z-[99999] bg-white border shadow-lg rounded-md transition-[width,height] duration-500 ease-in-out ",
        isOpen ? "w-[400px] h-[400px] " : "w-[70px] h-[34px]",
      )}
    >
      {/* header */}
      {isOpen ? (
      ...
      {isOpen ? (
        <div className="h-[350px] p-2  relative ">
