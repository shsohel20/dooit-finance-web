...
const Stepper = ({ currentStep, totalSteps, handleStep }) => {
  ...
  return (
    <div className="py-4">
      ...
      <div className="w-full h-2 relative mt-2  rounded-md overflow-hidden flex gap-2 ">
        {/* <div
        ...
        {Array.from({ length: totalSteps }).map((_, index) => (
          <div
            ...
            className={cn(
              "bg-gray-200 h-full cursor-pointer rounded-md transition-[width] duration-300 w-full ",
              {
