...
function SidebarGroupLabel({ className, asChild = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/30 ring-sidebar-ring flex h-6 shrink-0 items-center rounded-md px-2 !text-[0.65rem]  outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
